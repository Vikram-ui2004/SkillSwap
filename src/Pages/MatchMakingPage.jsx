...
const EnhancedNavbar = () => {
  ...
  const navItems = [
    ...
    { name: 'Matchmaking', icon: Heart, path: '/matchmaking', active: true },
    ...
    <>
      <motion.nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          isScrolled ? 'bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl shadow-2xl border-b border-purple-200/30'
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            >
              <div className="p-2 bg-gradient-to-br from-purple-600 via-pink-500 to-indigo-600 rounded-2xl shadow-lg">
                <Target className="text-white" size={22} />
              </div>
              <div className="text-left">
                <span className="text-2xl font-bold bg-gradient-to-r from-purple-600 via-pink-500 to-indigo-600 bg-clip-text text-transparent">
                  SkillSwap
                </span>
                <div className="text-xs text-purple-500 font-medium">Perfect Matches</div>
              </div>
            </button>
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-2xl font-medium transition ${
                      item.active
                        ? 'bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900/50 dark:to-pink-900/50 text-purple-700 dark:text-purple-300 shadow'
            ...
            <div className="flex items-center gap-3">
              <button
                className="relative p-2 text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20 rounded-2xl"
                aria-label="Notifications"
              >
                <Bell size={20} />
                <span className="absolute -top-1 -right-1 w-4 h-4 bg-gradient-to-r from-red-500 to-pink-500 rounded-full text-[10px] text-white grid place-items-center">
                  3
                </span>
              </button>
              ...
              <div className="hidden md:flex items-center gap-3">
                ...
                <img
                  ...
                  alt="Profile"
                  className="w-10 h-10 rounded-xl border border-purple-200"
                />
                <button
                  onClick={handleLogout}
                  className="p-2 text-gray-600 dark:text-gray-300 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-2xl"
                  aria-label="Logout"
                >
                  <LogOut size={18} />
                </button>
              ...
              <button
                ...
                className="md:hidden p-2 text-gray-600 dark:text-gray-300 hover:text-purple-600 hover:bg-purple-50 dark:hover:bg-purple-900/20 rounded-2xl"
        ...
        {showMobileMenu && (
          <>
            ...
            <motion.aside
              ...
              animate={{ x: 0 }}
              exit={{ x: '100%' }}
              className="fixed top-0 right-0 bottom-0 w-80 bg-white dark:bg-gray-900 z-50 md:hidden shadow-2xl border-l border-purple-200/30"
            ...
            >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 flex items-center gap-1">
                      Pro Member <Sparkles className="w-3 h-3 text-yellow-500" />
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 space-y-2">
                ...
                <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
                  <button
                    onClick={handleLogout}
                    className="w-full flex items-center gap-3 px-4 py-3 rounded-2xl text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition"
                  >
                    <LogOut size={20} />
